...
public class SqoopOptions implements Cloneable {
  ...
  // ODPS
  @StoredAsProperty("odps.table") private String odpsTable;
  @StoredAsProperty("odps.project") private String odpsProject;
  @StoredAsProperty("odps.accessid") private String odpsAccessID;
  @StoredAsProperty("odps.accesskey") private String odpsAccessKey;
  @StoredAsProperty("odps.endpoint") private String odpsEndPoint;
  @StoredAsProperty("odps.datahub.endpoint") private String odpsDatahubEndPoint;
  @StoredAsProperty("odps.tunnel.endpoint") private String odpsTunnelEndPoint;
  @StoredAsProperty("odps.partition.key") private String odpsPartitionKey;
  @StoredAsProperty("odps.partition.value") private String odpsPartitionValue;
  @StoredAsProperty("odps.create.table") private boolean odpsCreateTable;
  @StoredAsProperty("odps.input.dateformat") private String odpsInputDateFormat;
  @StoredAsProperty("odps.shardNum") private int odpsShardNum;
  @StoredAsProperty("odps.shardTimeout") private int odpsShardTimeout;
  @StoredAsProperty("odps.retryCount") private int odpsRetryCount;
  @StoredAsProperty("odps.batchSize") private int odpsBatchSize;
  ...
  private Properties mapColumnOdps;
  ...
  public void loadProperties(Properties props) {
    ...
    this.mapColumnOdps =
            getPropertiesAsNetstedProperties(props, "map.column.odps");
  ...
  public Object clone() {
    try {
      ...
      if (null != mapColumnOdps) {
        other.mapColumnOdps = (Properties) this.mapColumnOdps.clone();
      }
  ...
  private void initDefaults(Configuration baseConfiguration) {
    ...
    this.mapColumnOdps = new Properties();
    ...
    // ODPS default settings
    this.odpsHubLifeCycle = OdpsConstants.DEFAULT_HUBLIFECYCLE;
    this.odpsBatchSize = OdpsConstants.DEFAULT_BATCH_SIZE;
  ...
  */
  ...
  public String getOdpsDatahubEndPoint() {
    return odpsDatahubEndPoint;
  }

  public void setOdpsDatahubEndPoint(String odpsDatahubEndPoint) {
    this.odpsDatahubEndPoint = odpsDatahubEndPoint;
  }
  ...
  public String getOdpsPartitionKey() {
    return odpsPartitionKey;
  }

  public void setOdpsPartitionKey(String odpsPartitionKey) {
    this.odpsPartitionKey = odpsPartitionKey;
  }

  public String getOdpsPartitionValue() {
    return odpsPartitionValue;
  }

  public void setOdpsPartitionValue(String odpsPartitionValue) {
    this.odpsPartitionValue = odpsPartitionValue;
  }

  public boolean isOdpsCreateTable() {
    return odpsCreateTable;
  }
  ...
  public String getOdpsInputDateFormat() {
    return odpsInputDateFormat;
  }

  public void setOdpsInputDateFormat(String odpsInputDateFormat) {
    this.odpsInputDateFormat = odpsInputDateFormat;
  }

  public int getOdpsShardNum() {
    return odpsShardNum;
  }

  public void setOdpsShardNum(int odpsShardNum) {
    this.odpsShardNum = odpsShardNum;
  }

  public int getOdpsShardTimeout() {
    return odpsShardTimeout;
  }

  public void setOdpsShardTimeout(int odpsShardTimeout) {
    this.odpsShardTimeout = odpsShardTimeout;
  }

  public int getOdpsRetryCount() {
    return odpsRetryCount;
  }

  public void setOdpsRetryCount(int odpsRetryCount) {
    this.odpsRetryCount = odpsRetryCount;
  }

  public int getOdpsBatchSize() {
    return odpsBatchSize;
  }

  public void setOdpsBatchSize(int odpsBatchSize) {
    this.odpsBatchSize = odpsBatchSize;
  }

  public int getOdpsHubLifeCycle() {
    return odpsHubLifeCycle;
  }

  public void setOdpsHubLifeCycle(int odpsHubLifeCycle) {
    this.odpsHubLifeCycle = odpsHubLifeCycle;
  }

  public String getOdpsPartitionSpec() {
    return odpsPartitionSpec;
  }

  public void setOdpsPartitionSpec(String odpsPartitionSpec) {
    this.odpsPartitionSpec = odpsPartitionSpec;
  }

  public Properties getMapColumnOdps() {
    return mapColumnOdps;
  }

  public void setMapColumnOdps(String mapColumn) {
    parseColumnMapping(mapColumn, mapColumnOdps);
  }
}

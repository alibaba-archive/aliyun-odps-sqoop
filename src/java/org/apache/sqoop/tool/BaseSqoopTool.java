...
public abstract class BaseSqoopTool extends com.cloudera.sqoop.tool.SqoopTool {
  ...
  // ODPS arguments
  public static final String MAP_COLUMN_ODPS = "map-column-odps";
  public static final String ODPS_TABLE_ARG = "odps-table";
  public static final String ODPS_PROJECT_ARG = "odps-project";
  public static final String ODPS_ACCESS_ID_ARG = "odps-accessid";
  public static final String ODPS_ACCESS_KEY_ARG = "odps-accesskey";
  public static final String ODPS_ENDPOINT_ARG = "odps-endpoint";
  public static final String ODPS_DATAHUB_ENDPOINT_ARG = "odps-datahub-endpoint";
  public static final String ODPS_TUNNEL_ENDPOINT_ARG = "odps-tunnel-endpoint";
  public static final String ODPS_PARTITION_SPEC_ARG = "odps-partition-spec";

  public static final String ODPS_PARTITION_KEY_ARG = "odps-partition-keys";
  public static final String ODPS_PARTITION_VALUE_ARG = "odps-partition-values";
  public static final String ODPS_CREATE_TABLE_ARG = "create-odps-table";
  public static final String ODPS_DATEFORMAT_ARG = "odps-input-dateformat";
  public static final String ODPS_SHARDNUM_ARG = "odps-shard-num";
  public static final String ODPS_SHARDTIMEOUT_ARG = "odps-shard-timeout";
  public static final String ODPS_RETRY_COUNT_ARG = "odps-retry-count";
  ...
  protected void validateOdpsOptions(SqoopOptions options) throws InvalidOptionsException {
    boolean isDatahub = options.getOdpsDatahubEndPoint() != null;
    boolean isTunnel = options.getOdpsTunnelEndPoint() != null;
    if (options.getOdpsTable() != null && ! (isDatahub ^ isTunnel)) {
      throw new InvalidOptionsException("One and only one of the two parameters, --odps-datahub-endpoint " +
        "and --odps-tunnel-endpoint, should be specified");
    }
